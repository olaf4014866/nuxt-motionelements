<template>
  <div class="modal fade" id="favgrp-filters" tabindex="-1" role="dialog" aria-hidden="true">
    <!-- use on 3 block-->
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6 mb-3">
              ...
              <div class="custom-control custom-checkbox">
                <input
                  @click="selectOneElementType($event, 'ae')"
                  :checked="(inputElementTypes.indexOf('ae') >= 0)"
                  value="ae"
                  type="checkbox"
                  class="custom-control-input"
                  id="filter-mt-ae"
                >
                <label class="custom-control-label" for="filter-mt-ae">
                  <i class="fas fa-fw text-muted me-bmt icon-after-effects-square"></i>
