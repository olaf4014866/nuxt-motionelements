<template>
  <div class="container">
    <div
      class="d-flex flex-sm-nowrap flex-column align-items-center"
      :class="{ 'flex-sm-row': !layoutVertical }"
    >
      <!-- ALBUM ARTWORK -->
...
export default {
  ...
  computed: {
    ...
    getAlbumArt() {
      if (this.apiData.album_art && this.apiData.album_art.jpg.url) {
        return this.apiData.album_art.jpg.url;
      }
