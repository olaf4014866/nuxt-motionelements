...
export default {
  ...
  mounted() {
    ...
    // const currentKeyword = this.$store.getters['search/keyword'];
    this.inputValue = this.$store.getters['search/keyword'];
  ...
  methods: {
    ...
    handleHit(evt) {
      ...
      this.$store.dispatch('search/setKeyword', this.inputValue);

      changeKeyword(this.inputValue);
