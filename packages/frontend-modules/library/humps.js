(function (global, factory) {
	...
	(global = global || self, global.humps = factory());
	  ...
	  (function () {
	    ...
	    var Un = {
	      ...
	      "\u2029": "u2029"
	        ...
	        Cn = parseFloat,
	        Dn = parseInt,
	        Mn = _typeof(commonjsGlobal) == "object" && commonjsGlobal && commonjsGlobal.Object === Object && commonjsGlobal,
	...
	var string = createCommonjsModule(function (module, exports) {
	  ...
	  exports.default = void 0; // https://github.com/cape-io/lodash-humps/blob/master/src/createHumps.js
	  // import { camelCase } from 'lodash/fp';

	  function createIteratee(converter, self) {
	    return function (result, value, key) {
	      return (0, lodash.set)(result, converter(key), (0, fp.isObjectLike)(value) ? self(value) : value);
	    };
	  }

	  function createHumps(keyConverter) {
	    return function humps(node) {
	      if ((0, fp.isArray)(node)) return (0, fp.map)(humps, node);
	      if ((0, fp.isPlainObject)(node)) return (0, lodash.transform)(node, createIteratee(keyConverter, humps));
	      return node;
	    };
	  ...
	  var _default = createHumps(fp.camelCase);
