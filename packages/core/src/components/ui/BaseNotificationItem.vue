<template>
  ...
  <div
    :class="`border-${notification.level}`"
  ...
  >
    <div class="toast-header justify-content-between">
      ...
      >
        ...
        <span v-else>{{ notification.level | capitalize }}</span>
      </strong>
    ...
    <div v-if="notification.detail" v-html="notification.detail" class="toast-body"></div>
  </div>
</template>

<script>
export default {
  name: 'base-notification-item',
  props: {
    notification: {},
  },
  mounted() {
